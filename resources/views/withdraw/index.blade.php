...
<body>
    ...
    <div class="container">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <p>Type: {{ Str::upper(Auth::user()->account_type) }} </p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" class="btn btn-primary withdrawBtn">
                    - Withdraw
                </button>
            </div>
            <div class="card-body">
                            ...
                            @if (count($transactions))
                                @foreach ($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td>{{ Str::upper($transaction->transaction_type) }}</td>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" id="withdraw-form" action="{{ route('withdraw.store') }}">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="{{Auth::user()->balance}}" value="" name="amount" class="form-control"
                                        id="amount" required />
                                    <small class="error error-amount text-danger"></small>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).on('click', '.withdrawBtn, .close', function(e) {
            e.preventDefault();
