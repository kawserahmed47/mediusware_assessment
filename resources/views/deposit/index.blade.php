...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" class="btn btn-primary addDeposit">
                    + Deposit
                </button>
            </div>
            <div class="card-body">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" id="deposit-form" action="{{ route('deposit.store') }}">
                    @csrf
    ...
    <script>
        ...
        $(document).on('click', '.addDeposit, .close', function(e){
            e.preventDefault();
